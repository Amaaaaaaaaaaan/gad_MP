...
Public Class GAD_MP_Form1_Home
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GAD_MP_Form1_Home()
        'this below is order id that will store in database'
        Dim myValue As String = ""
        Dim prefix As String = "ORD"
        Dim r As New Random()
        Dim suffix As String = DateTime.Now.ToString("yyyyMMddHHmmss")
        Dim orderNum As String = prefix & "-" & suffix & "-" & r.Next(111111, 999999) 'generates random order number between 111111 and 999999' 
        ...
        PictureBox1.Image = images(currentImageIndex) 'TOp BOx A
        PictureBox2.Image = images(currentImageIndex) ' Top Box B

        GAD_MP_Form1_Home_T2.Interval = 1000 ' BOx Image change interval
    ...
    Private Sub GAD_MP_Form1_Home_Login_Btn_Click(sender As Object, e As EventArgs) Handles GAD_MP_Form1_Home_Login_Btn.Click
        'below to handle if error occured'
        ...
        Else
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If GAD_MP_Form1_Home_Login_UsernameTextBox.Text = dtuser And GAD_MP_Form1_Home_Login_PasswordTextBox.Text = dtpass Then
                    'checks if user is there in data base or not if yes then CanLogin becomes True'
                    SessionUser = dtuser
                    CanLogin = True
    ...
    Private Sub GAD_MP_Form1_Home_Login_SignUpLink_Click(sender As Object, e As EventArgs) Handles GAD_MP_Form1_Home_Login_SignUpLink.Click
        'code to make a new account and then redirect to page to sign up'
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If currentImageIndex1 >= 21 Then
            ...
            'changing the two images at top panel'
    ...
    Private Sub GAD_MP_Form1_Home_LoginPanel_Paint(sender As Object, e As PaintEventArgs) Handles GAD_MP_Form1_Home_LoginPanel.Paint

    End Sub

    Private Sub GAD_MP_Form1_Home_TitlePanel_Paint(sender As Object, e As PaintEventArgs) Handles GAD_MP_Form1_Home_TitlePanel.Paint
    ...
    Private Sub GAD_MP_Form1_Home_Login_UsernameTextBox_TextChanged(sender As Object, e As EventArgs) Handles GAD_MP_Form1_Home_Login_UsernameTextBox.TextChanged
