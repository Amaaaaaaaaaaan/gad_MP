...
Public Class GAD_MP_Info3_Desserts_IceCream
    ...
    Private Sub GAD_MP_Info3_Desserts_IceCream_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Ice Cream Softie"

        Label3.Text = "Made with the creamiest, " & vbCrLf & "silkiest ice cream, our " & vbCrLf & "Ice Softie is a luxurious " & vbCrLf & "delight that will melt in your" & vbCrLf & " mouth and make your" & vbCrLf & " taste buds dance with joy. "
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        GAD_MP_Info5_ItemAdded_Desserts.softie.Visible = True
